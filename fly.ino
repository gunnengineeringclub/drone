...
//      value = Serial.parseInt();    // Parse an Integer from Serial
    ...
    side = getStickValue(1);
    forward = getStickValue(2);
    throttle = getStickValue(3);
    throttleside = getStickValue(4);
...
//    automation code goes here
   ...
   if(ypr[1] < desiredSideways - accuracy)
   {
      m2speed = sp + 300;
      m3speed = sp + 300;
   }
   else if(ypr[1] > desiredSideways + accuracy)
   {
      m1speed = sp + 300;
      m4speed = sp + 300;
   }

   if(ypr[2] < desiredForward - accuracy)
   {
      m1speed = sp + 300;
      m2speed = sp + 300;
   }
   else if(ypr[2] > desiredSideways + accuracy)
   {
      m3speed = sp + 300;
      m4speed = sp + 300;
   }
